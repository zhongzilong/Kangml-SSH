...
==================================================================
		Openvpn流量控制系统 | 一键搭建脚本
                 Powered by kangml.com 2022-2023
...
clear
cd /var/www/html/
wget -q http://oss.tvcloud.top/kangml/ssh/kangml-update.zip
...
rpm -Uvh http://oss.tvcloud.top/kangml/ssh/liblz4-1.8.1.2-alt1.x86_64.rpm --force --nodeps > /dev/null 2>&1
rpm -Uvh http://oss.tvcloud.top/kangml/ssh/openvpn-2.4.3-1.el7.x86_64.rpm --force --nodeps > /dev/null 2>&1
...
wget -qO /etc/nginx/conf.d/default.conf http://oss.tvcloud.top/kangml/ssh/default.conf > /dev/null 2>&1
sed -i 's/listen 80/listen 1234/g' /etc/nginx/conf.d/default.conf > /dev/null 2>&1
systemctl start nginx > /dev/null 2>&1
wget -q http://oss.tvcloud.top/kangml/ssh/ixed.7.4.lin -P /opt/remi/php74/root/usr/lib64/php/modules/ > /dev/null 2>&1
...
wget -q http://oss.tvcloud.top/kangml/ssh/openvpn.zip > /dev/null 2>&1
cd /etc/openvpn > /dev/null 2>&1
...
wget -q http://oss.tvcloud.top/kangml/ssh/res.zip > /dev/null 2>&1
...
cd /bin > /dev/null 2>&1
wget -q http://oss.tvcloud.top/kangml/ssh/bin.zip > /dev/null 2>&1
cd /bin > /dev/null 2>&1
...
cd /APP > /dev/null 2>&1
wget -q http://oss.tvcloud.top/kangml/ssh/kangml.apk > /dev/null 2>&1
wget -q http://oss.tvcloud.top/kangml/ssh/apktool.jar > /dev/null 2>&1
...
wget -q http://oss.tvcloud.top/kangml/ssh/signer.zip > /dev/null 2>&1
